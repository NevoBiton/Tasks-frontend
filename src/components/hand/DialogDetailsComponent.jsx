...
//         isPinned: task.isPinned,
//     });
//     // New state to manage new todo input
//     const [newTodoTitle, setNewTodoTitle] = useState('');
...
//     // New function to handle adding a new todo
//     function handleAddTodo() {
//         if (newTodoTitle.trim()) {
//             const newTodo = { title: newTodoTitle, isComplete: false };
//             const updatedTodos = [...todos, newTodo];
...
//                                 </div>
//                             ))}
//                             {/* New input and button to add new todos */}
//                             <div className="flex items-center gap-2 mt-2">
//                                 <Input
//                                     className="h-6 w-full"
//                                     type="text"
...
//                                 {todos.map((todo, index) => (
//                                     <div key={index} className="flex items-center justify-between">
//                                         <Label className="text-l">{todo.title}</Label>
//                                         <Input
//                                             className="h-6 w-fit"
//                                             type="checkbox"
//                                             checked={todo.isComplete}
...
//                 </DialogHeader>
//                 <div className="flex justify-end gap-2 mt-4">
//                     <Button className="p-2" onClick={handleEditClick}>
//                         {isEditing ? "Cancel" : <FilePenLine />}
//                     </Button>
//                     {isEditing && (
//                         <Button className="p-2" onClick={handleSaveClick}>Save</Button>
//                     )}
//                 </div>
//             </DialogContent>
//         </Dialog>
